...
#     unit_map, unit_unmapped, df_unit_map = mapping.generate_unit_map(entity_orig=lst_units)
...
#
#     # step 1: generate feature map
#     feature_map2, feature_unmapped2, df_feature_map2 = mapping.generate_feature_map(entity_orig=list(df_temp.iloc[2, 5:]))
#     assert(feature_map2 == {'chloride': 'Cl', 'manganese': 'Mn', 'nietrate': 'NO3', 'nitrate (filtered)': 'NO3'})
#
#     # step 2: generate unit map
#     unit_map2, unit_unmapped2, df_unit_map2 = mapping.generate_unit_map(entity_orig=list(df_temp.iloc[3, 5:]))
...
#     print(mapping.generate_feature_alias().head())
#
#     """
...
#     df_feature_alias = mapping.generate_entity_alias(
#         df=mapping.entire_feature_alias_table(),
#         entity_col='Feature',
#         alias_cols=['IUPAC'])
#
#     df_temp = pd.read_excel(Path(__file__).cwd()/'tests/example1.xlsx', sheet_name='wide', header=None) # ignore headers!
#     feature_map3, feature_unmapped3, df_feature_map3 = mapping.generate_feature_map(entity_orig=list(df_temp.iloc[1, 5:]),
...
#     print(mapping.generate_unit_alias().head(2))
#
#     """
#     WARNING:
#     give pH as units '1'
